...
function autoCollecting() {
    if (gameData.autoCollectingBar == eval(autoCollectingVariable) || gameData.autoCollectingBar == 0) {
...
function autoCollectingBar() {
    if (gameData.autoCollectingBar < eval(autoCollectingVariable)) {
    ...
    if (gameData.autoCollectingBar % (10 / (gameData.shoes + 1 + rate)) == 0 && gameData.autoCollectingBar != eval(autoCollectingVariable)) {
        getLimes()
    }
