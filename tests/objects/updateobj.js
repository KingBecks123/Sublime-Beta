	...
	updateObjMain = [
		{
			...
			id: 'trueLimes',
			content: 'True Limes: ' + gameData.trueLimes.toLocaleString()
		}, {
			...
			content: 'You Will Get ' + gameData.juiceSellReward.toLocaleString() + ' Coins'
		}, {
			...
			id: 'lordEmotion',
			content: 'The lord is ' + lordEmotion
		}, {
			id: 'lordsRice',
			content: 'Lord&#39;s rice: ' + gameData.serf.lordsRice
		}, {
			id: 'wheatNumber',
